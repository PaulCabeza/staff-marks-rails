...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { address: @mark.address, latitude: @mark.latitude, longitude: @mark.longitude, mark_type: @mark.mark_type } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { address: @mark.address, latitude: @mark.latitude, longitude: @mark.longitude, mark_type: @mark.mark_type } }
